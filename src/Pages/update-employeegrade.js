...
function UpdateEmployeeGrade(){
    ...
    return(
        <div>
            <Helmet>
                    <title>HRMS | Update Grade to Employee</title>
                </Helmet>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 className="mb-0 font-size-18">Update Grade to Employee</h4>

                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            <li className="breadcrumb-item"><a href="#">Manage Cities</a></li>
                                            <li className="breadcrumb-item active">Update Grade to Employee</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
...
export default UpdateEmployeeGrade;